...
public class OptionsGui extends JPanel {
	...
	public static final ScreenElement COMMENT_AUTO = new ScreenElement("Comment, Automatic", findColor("Comment.auto"));
	public static final ScreenElement ADDRESS = new ScreenElement("Address", findColor("Address"));
	public static final ScreenElement BACKGROUND = new ScreenElement("Background", findColor("Text.Background"));
	public static final ScreenElement BAD_REF_ADDR = new ScreenElement("Bad Reference Address", findColor("Bad.Ref.Addr"));
	...
	public static final ScreenElement LABELS_UNREFD = new ScreenElement("Labels, Unreferenced", findColor("Labels.Unrefd"));
	public static final ScreenElement ENTRY_POINT = new ScreenElement("Entry Point", findColor("Entry.Point"));
	public static final ScreenElement COMMENT_EOL = new ScreenElement("Comment, EOL", "EOL Comment", findColor("Comment.Eol"));
	public static final ScreenElement EXT_REF_RESOLVED = new ScreenElement("External Reference, Resolved", findColor("Ext.Ref.Resolved"));
	public static final ScreenElement FIELD_NAME = new ScreenElement("Field Name", findColor("Field.Name"));
	public static final ScreenElement FUN_CALL_FIXUP = new ScreenElement("Function Call-Fixup", findColor("Fun.Call.FixUp"));
	public static final ScreenElement FUN_NAME = new ScreenElement("Function Name", findColor("Fun.Name"));
	public static final ScreenElement FUN_PARAMS = new ScreenElement("Function Parameters", findColor("Fun.Params"));
	public static final ScreenElement FUN_TAG = new ScreenElement("Function Tag", findColor("Fun.Tag"));
	public static final ScreenElement FUN_AUTO_PARAMS = new ScreenElement("Function Auto-Parameters", findColor("Fun.Auto.Params"));
	public static final ScreenElement FUN_RET_TYPE = new ScreenElement("Function Return Type", findColor("Fun.Ret.Type"));
	public static final ScreenElement COMMENT_REPEATABLE = new ScreenElement("Comment, Repeatable", findColor("Comment.Repeatable"));
	public static final ScreenElement COMMENT_REF_REPEAT = new ScreenElement("Comment, Referenced Repeatable", findColor("Comment.Ref.Repeat"));
	public static final ScreenElement LABELS_LOCAL = new ScreenElement("Labels, Local", findColor("Labels.Local"));
	public static final ScreenElement MNEMONIC_OVERRIDE = new ScreenElement("Mnemonic, Override", findColor("Mnemonic.Override"));
	public static final ScreenElement MNEMONIC = new ScreenElement("Mnemonic", findColor("Mnemonic"));
	public static final ScreenElement FLOW_ARROW_NON_ACTIVE = new ScreenElement("Flow Arrow, Not Active", findColor("Flow.Arrow.Non.Active"));
	public static final ScreenElement FLOW_ARROW_ACTIVE = new ScreenElement("Flow Arrow, Active", findColor("Flow.Arrow.Active"));
	public static final ScreenElement FLOW_ARROW_SELECTED = new ScreenElement("Flow Arrow, Selected", findColor("Flow.Arrow.Selected"));
	public static final ScreenElement LABELS_NON_PRIMARY = new ScreenElement("Labels, Non-primary", findColor("Labels.Non.Primary"));
	public static final ScreenElement COMMENT_PLATE = new ScreenElement("Comment, Plate", "Plate Comment", findColor("Comment.Plate"));
	public static final ScreenElement COMMENT_POST = new ScreenElement("Comment, Post", "Post-Comment", findColor("Comment.Post"));
	public static final ScreenElement COMMENT_PRE = new ScreenElement("Comment, Pre", "Pre-Comment", findColor("Comment.Pre"));
	public static final ScreenElement LABELS_PRIMARY = new ScreenElement("Labels, Primary", findColor("Labels.Primary"));
	...
	public static final ScreenElement PARAMETER_CUSTOM = new ScreenElement("Parameter, Custom Storage", findColor("Parameter.Custom"));
	public static final ScreenElement PARAMETER_DYNAMIC = new ScreenElement("Parameter, Dynamic Storage", findColor("Parameter.Dynamic"));
	public static final ScreenElement VERSION_TRAK = new ScreenElement("Version Track", findColor("Version.Task"));
	...
	public static final ScreenElement XREF_READ = new ScreenElement("XRef Read", findColor("Xref.Read"));
	public static final ScreenElement XREF_WRITE = new ScreenElement("XRef Write", findColor("Xref.Write"));
	public static final ScreenElement XREF_OTHER = new ScreenElement("XRef Other", findColor("Xref.Other"));
